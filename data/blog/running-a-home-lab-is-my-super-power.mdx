...
tags:
  - technology
summary: >-
  It started with a single Raspberry Pi behind the TV. Fifteen years later it
  is a Proxmox cluster, a NAS, and a museum of my own decisions. This is what
  self-hosting teaches you that the cloud never will, and why it is the reason
  I can see every layer other engineers only click a button on.
---
