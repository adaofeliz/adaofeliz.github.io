...
draft: false
summary: >-
  Every day, our operations team manually routes field technicians: prioritizing
  tickets, plotting maps, syncing calendars, sending confirmations. It is the
  kind of workflow you want to automate. We started with frontier models, hit a
  cost wall, then dove into multi-agent systems to fix it. Costs dropped, but
  scaling was impossible. The answer was not more agents. It was hiding the
  complexity entirely.
audio: 'https://audio.adaofeliz.com/my-state-of-ai-_-the-multi-agent-illusion.mp3'
audioTimestamps: >-
  https://audio.adaofeliz.com/my-state-of-ai-_-the-multi-agent-illusion-timestamps.json
---
