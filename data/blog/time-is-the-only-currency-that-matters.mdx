...
audioTimestamps: >-
  https://audio.adaofeliz.com/time-is-the-only-currency-that-matters-timestamps.json
mindmap: /static/mindmaps/time-is-the-only-currency-that-matters.svg
images:
  - /static/mindmaps/time-is-the-only-currency-that-matters-og.png
---
