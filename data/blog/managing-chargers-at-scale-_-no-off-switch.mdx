...
summary: >-
  ...
  control. Building a backend for machines that live outside your network, in
  the physical world, is not. The first of three posts about managing chargers
  at scale. What the edges actually do to a platform, and why my team builds the
  foundation by hand.
audio: 'https://audio.adaofeliz.com/managing-chargers-at-scale-_-no-off-switch.mp3'
audioTimestamps: >-
  https://audio.adaofeliz.com/managing-chargers-at-scale-_-no-off-switch-timestamps.json
---
